...
using System;
namespace Polaris.Api.Client.Search.LargeAssets
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Polaris.Api.Client.Search.LargeAssets.LargeAssetsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<List<global::Polaris.Api.Client.Models.AssetResponseDto>?> PostAsync(Action<RequestConfiguration<global::Polaris.Api.Client.Search.LargeAssets.LargeAssetsRequestBuilder.LargeAssetsRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::Polaris.Api.Client.Models.AssetResponseDto>> PostAsync(Action<RequestConfiguration<global::Polaris.Api.Client.Search.LargeAssets.LargeAssetsRequestBuilder.LargeAssetsRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Action<RequestConfiguration<global::Polaris.Api.Client.Search.LargeAssets.LargeAssetsRequestBuilder.LargeAssetsRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Action<RequestConfiguration<global::Polaris.Api.Client.Search.LargeAssets.LargeAssetsRequestBuilder.LargeAssetsRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Polaris.Api.Client.Search.LargeAssets.LargeAssetsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Polaris.Api.Client.Search.LargeAssets.LargeAssetsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Polaris.Api.Client.Search.LargeAssets.LargeAssetsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Search for assets that are considered large based on specified criteria.
        /// </summary>
