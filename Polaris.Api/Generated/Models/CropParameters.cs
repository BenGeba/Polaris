...
namespace Polaris.Api.Client.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Polaris.Api.Client.Models.CropParameters"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Polaris.Api.Client.Models.CropParameters CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Polaris.Api.Client.Models.CropParameters();
        }
        /// <summary>
