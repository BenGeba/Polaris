...
using System;
namespace Polaris.Api.Client.Timeline.Buckets
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Polaris.Api.Client.Timeline.Buckets.BucketsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A List&lt;global::Polaris.Api.Client.Models.TimeBucketsResponseDto&gt;</returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<List<global::Polaris.Api.Client.Models.TimeBucketsResponseDto>?> GetAsync(Action<RequestConfiguration<global::Polaris.Api.Client.Timeline.Buckets.BucketsRequestBuilder.BucketsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::Polaris.Api.Client.Models.TimeBucketsResponseDto>> GetAsync(Action<RequestConfiguration<global::Polaris.Api.Client.Timeline.Buckets.BucketsRequestBuilder.BucketsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::Polaris.Api.Client.Models.TimeBucketsResponseDto>(requestInfo, global::Polaris.Api.Client.Models.TimeBucketsResponseDto.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Polaris.Api.Client.Timeline.Buckets.BucketsRequestBuilder.BucketsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Polaris.Api.Client.Timeline.Buckets.BucketsRequestBuilder.BucketsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Polaris.Api.Client.Timeline.Buckets.BucketsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Polaris.Api.Client.Timeline.Buckets.BucketsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Polaris.Api.Client.Timeline.Buckets.BucketsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieve a list of all minimal time buckets.
        /// </summary>
...
#nullable restore
            ...
            public global::Polaris.Api.Client.Models.AssetOrder? Order { get; set; }
            ...
            public global::Polaris.Api.Client.Models.AssetOrderBy? OrderBy { get; set; }
