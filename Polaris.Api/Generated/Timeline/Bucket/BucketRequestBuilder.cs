...
using System;
namespace Polaris.Api.Client.Timeline.Bucket
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Polaris.Api.Client.Timeline.Bucket.BucketRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Polaris.Api.Client.Models.TimeBucketAssetResponseDto"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Polaris.Api.Client.Models.TimeBucketAssetResponseDto?> GetAsync(Action<RequestConfiguration<global::Polaris.Api.Client.Timeline.Bucket.BucketRequestBuilder.BucketRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Polaris.Api.Client.Models.TimeBucketAssetResponseDto> GetAsync(Action<RequestConfiguration<global::Polaris.Api.Client.Timeline.Bucket.BucketRequestBuilder.BucketRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Polaris.Api.Client.Models.TimeBucketAssetResponseDto>(requestInfo, global::Polaris.Api.Client.Models.TimeBucketAssetResponseDto.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Retrieve a string of all asset ids in a given time bucket.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Polaris.Api.Client.Timeline.Bucket.BucketRequestBuilder.BucketRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Polaris.Api.Client.Timeline.Bucket.BucketRequestBuilder.BucketRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Polaris.Api.Client.Timeline.Bucket.BucketRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Polaris.Api.Client.Timeline.Bucket.BucketRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Polaris.Api.Client.Timeline.Bucket.BucketRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieve a string of all asset ids in a given time bucket.
        /// </summary>
